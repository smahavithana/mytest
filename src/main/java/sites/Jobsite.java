...
public class Jobsite {
    ...
    public static void getJobs(String jobsite) throws Exception {
        ...
        try {
            ...
            int s = ele.select("div.lineage.vacRow.clearfix.job").size();
            Job myJobs[] = new Job[s];

            for (Element element : ele.select("div.lineage.vacRow.clearfix.job")) {
            ...
            XMLHelper.writeFromArray("jobsite", myJobs);
